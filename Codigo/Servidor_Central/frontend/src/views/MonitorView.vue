...
async function carregar() {
  ...
  try {
    ...
    erro.value = e instanceof Error ? e.message : 'Falha ao carregar monitor'
  } finally {
    loading.value = false
  }
}
            ...
            <TableBody>
              ...
              >
                ...
                <TableCell>
                  ...
                  <Badge
                    v-else
                    class="bg-[#f1f5f9] text-[#64748b] text-[11px] font-bold px-2 py-0.5 border-none shadow-none"
                  >
                    {{ l.estado }}
                  </Badge>
                </TableCell>
