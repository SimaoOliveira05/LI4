    ...
    <div class="p-5 border-t border-slate-100 bg-slate-50/50">
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1 min-w-0">
          <p class="text-[13px] font-bold text-[#0f172a] truncate">Jon Doe</p>
          <button class="text-[11px] font-bold text-[#ef4444] hover:text-red-700 transition-colors uppercase tracking-tight">Terminar Sessão</button>
        </div>
